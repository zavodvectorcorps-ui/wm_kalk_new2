...
**Feature: Фильтрация и календарь CRM по дате залички (prepaymentDate)**
- Фильтрация сделок, сортировка канбана, список и календарь CRM переведены с readyDate на prepaymentDate
- В карточках канбана и списке отображается дата залички
