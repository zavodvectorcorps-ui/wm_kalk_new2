...
- Категории: Модель/Размер, Исполнение, Цвет сауны/крыши (из калькулятора), Лавки (фото+вариант из калькулятора), Подспинники, Ограждение печки, Печь (условные поля: Электро→мощность / Дровяная→внутр/вынос), Дымоход, Форточки, Панорама, Дверь, Скамьи 1/2, Душевой поддон, Бойлер, Электрика (Парная/Комната/Внешний)
- Автоматический перенос данных из калькулятора через calcCategoryMapping
- Условные поля (печь), секционные заголовки, лавки с фото
