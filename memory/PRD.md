...
**Feature: Дата заливки (pouringDate) — фильтрация и календарь**
- Добавлено поле `pouringDate` (Дата заливки) в модель CRM-лида
- Фильтрация сделок по дате переведена с readyDate на pouringDate
- Календарь CRM теперь группирует заказы по дате заливки
- Сортировка канбан-колонок и списка по дате заливки
- Поле "Дата заливки" добавлено в карточку лида (первое в ряду 4 дат)
