...
BACKEND_URL = "https://sauna-content-pro.preview.emergentagent.com/api"
...
def test_balia_pdf_generation():
    ...
    try:
        ...
        pdf_request = {
            ...
            "modelPrice": 1250,
            "modelImageUrl": "https://sauna-content-pro.preview.emergentagent.com/api/uploads/27fa922f2f7a4d808e41d1a7eb18eb23.png",
            "selectedOptions": [
                {
...
def test_pdf_generation_with_model_images():
    ...
    try:
        balia_request = {
            ...
            "modelName": "Купель 200см (внешний нагрев)",
            "modelPrice": 1250,
            "modelImageUrl": "https://sauna-content-pro.preview.emergentagent.com/api/uploads/a1f675940c1c4133bc3719673494cf1e.jpg",
            "selectedOptions": [
                {
                    "categoryId": "hydromassage", 
                    "optionId": "hydro_6_8", 
