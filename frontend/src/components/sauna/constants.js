...
export const translations = {
  ru: {
    ...
    certificatePayment: 'Оплата сертификатом (-18%)',
    certificateApplied: 'Скидка сертификата применена: 18%',
    ...
    cancel: 'Отмена',
    saveChangesAndPdf: 'Сохранить изменения и скачать PDF',
  ...
  pl: {
    ...
    certificatePayment: 'Płatność certyfikatem (-18%)',
    certificateApplied: 'Rabat certyfikatu zastosowany: 18%',
    ...
    cancel: 'Anuluj',
    saveChangesAndPdf: 'Zapisz zmiany i pobierz PDF',
