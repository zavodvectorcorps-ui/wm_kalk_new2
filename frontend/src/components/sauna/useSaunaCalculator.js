        ...
        Object.entries(selection).forEach(([optId, isSelected]) => {
          if (isSelected) {
            ...
            options.push({
              ...
              optionNameRu: (() => { const b = option.nameRu || option.name; const vr = selectedVariant ? (selectedVariant.nameRu || selectedVariant.namePl || selectedVariant.name) : ''; return vr ? `${b} (${vr})` : b; })(),
              price: finalPrice,
