                ...
                {selectedModel.heaterVariants.map((variant, idx) => (
                  ...
                  >
                    ...
                    <p className="font-medium text-center">
                      {variant.type === 'integrated' ? 'Piec zintegrowany' : variant.type === 'none' ? 'Bez pieca' : variant.type === 'electric' ? 'Piec elektryczny' : 'Piec zewnętrzny'}
                    </p>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="md:w-2/3 space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {selectedHeaterVariant?.type === 'integrated' ? 'Piec zintegrowany' : selectedHeaterVariant?.type === 'none' ? 'Bez pieca' : selectedHeaterVariant?.type === 'electric' ? 'Piec elektryczny' : 'Piec zewnętrzny'}
                  </p>
