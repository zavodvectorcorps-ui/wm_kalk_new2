...
import { MapPin, Navigation, RefreshCw, Eye, Filter, Warehouse } from 'lucide-react';
import { mapContainerStyle, defaultCenter, formatDistance, formatDuration, getMapOrders, getMarkerIcon } from './constants';
...
const OrdersMap = ({
  ...
  const mapOrders = getMapOrders(orders, mapFilter);
              ...
              return (
                <Marker
                  ...
                  icon={isSelected ? {
                    ...
                    strokeColor: 'white',
                    strokeWeight: 2
                  } : getMarkerIcon(order, window.google)}
