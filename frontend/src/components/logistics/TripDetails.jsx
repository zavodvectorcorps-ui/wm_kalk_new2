...
import { 
  ...
  RefreshCw, Navigation, MapPin, Phone
} from 'lucide-react';
import { TRIP_STATUSES, ORDER_TRIP_STATUSES, formatDistance, formatDuration } from './constants';
    ...
    return (
      <Card className="h-full">
        <CardHeader className="pb-3">
          <CardTitle className="text-base">Детали рейса</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8 text-muted-foreground">
            <Route className="h-12 w-12 mx-auto mb-3 opacity-50" />
            <p>Выберите рейс из списка</p>
          </div>
        </CardContent>
      </Card>
    );
        ...
        <CardContent>
          <div className="h-[400px] bg-muted rounded-lg flex items-center justify-center">
            <p className="text-muted-foreground text-center">
              Выберите рейс для<br/>просмотра маршрута
            </p>
          </div>
        </CardContent>
      </Card>
