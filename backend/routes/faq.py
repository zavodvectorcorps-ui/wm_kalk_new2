...
Точная стоимость рассчитывается после указания адреса в калькуляторе.""",
        ...
        # ============ LAYOUT VARIANTS - SAUNA ============
        {
            "calculator_type": "sauna",
            "category": "layout_variants",
            "question": "Отличия комплектаций Standard и Plus",
            "answer": """📊 СРАВНЕНИЕ КОМПЛЕКТАЦИЙ

┌─────────────────────────┬───────────────┬───────────────┐
│ Опция                   │  Standard     │    Plus       │
├─────────────────────────┼───────────────┼───────────────┤
│ Древесина               │  Класс В      │  Класс А      │
│ Освещение               │  Лампы        │  LED          │
│ Защита печи             │  Доп. опция   │  Включено     │
│ Уличное освещение       │  Доп. опция   │  Включено     │
│ Подспинники в парной    │  Доп. опция   │  Включено     │
└─────────────────────────┴───────────────┴───────────────┘

✨ ПРЕИМУЩЕСТВА PLUS:
• Древесина высшего качества (Класс А)
• Современное LED-освещение
• Все необходимые опции уже включены в стоимость
• Готовая комплектация — не нужно выбирать доп. опции""",
            "order": 1
        },
        {
            "calculator_type": "sauna",
            "category": "layout_variants",
            "question": "Варианты планировок по размерам",
            "answer": """📐 РАЗМЕРЫ ПОМЕЩЕНИЙ В ЗАВИСИМОСТИ ОТ ВАРИАНТА

Все размеры указаны в сантиметрах (ширина помещения).

┌────────┬─────────────────────────────────────────────────────┐
│ Размер │        Вариант 1 (Стандарт)                         │
│ сауны  │  Терраса  │  К. отдыха  │  Парная   │  Вход         │
├────────┼───────────┼─────────────┼───────────┼───────────────┤
│  2м    │    —      │     175     │   Только  │    Прямой     │
│  2,5м  │    —      │     225     │   парная  │    Прямой     │
│  3м    │    95     │     175     │           │    Прямой     │
│  3,5м  │   135     │     185     │           │   П или Б     │
│  4м    │   185     │     185     │           │   Боковой     │
│  5м    │   285     │     185     │           │   Боковой     │
│  6м    │   до 233  │      —      │           │     —         │
└────────┴───────────┴─────────────┴───────────┴───────────────┘
...
• П — Прямой вход
• Б — Боковой вход
• «—» — не предусмотрено в данной конфигурации""",
            "order": 2
        },
        {
            "calculator_type": "sauna",
            "category": "layout_variants",
            "question": "Вариант 2: Увеличенная парная",
            "answer": """🔥 ВАРИАНТ 2: УВЕЛИЧЕННАЯ ПАРНАЯ

Для клиентов, которым важен большой размер парной.

┌────────┬───────────┬─────────────┬───────────┬───────────────┐
│ Размер │  Терраса  │  К. отдыха  │  Парная   │  Вход         │
├────────┼───────────┼─────────────┼───────────┼───────────────┤
│  3,5м  │    95     │     225     │   Увелич. │    Прямой     │
│  4м    │   145     │     225     │   парная  │    Боковой    │
│  5м    │   245     │     225     │           │    Боковой    │
└────────┴───────────┴─────────────┴───────────┴───────────────┘

✨ ОСОБЕННОСТИ:
• Увеличенная площадь парной (225 см)
• Оптимально для семей 4+ человек
• Больше места для полок
• Доступно для размеров от 3,5 метров""",
            "order": 3
        },
        {
            "calculator_type": "sauna",
            "category": "layout_variants",
            "question": "Вариант 3: Экстра терраса",
            "answer": """🏡 ВАРИАНТ 3: ЭКСТРА ТЕРРАСА

Для клиентов, которым важна большая зона отдыха на открытом воздухе.

┌────────┬───────────┬─────────────┬───────────┬───────────────┐
│ Размер │  Терраса  │  К. отдыха  │  Парная   │  Вход         │
├────────┼───────────┼─────────────┼───────────┼───────────────┤
│  3м    │    50     │     183     │   Компакт.│    Прямой     │
│  3,5м  │    50     │     233     │   парная  │    Прямой     │
│  4м    │    50     │      95     │     183   │    Прямой     │
└────────┴───────────┴─────────────┴───────────┴───────────────┘

✨ ОСОБЕННОСТИ:
• Увеличенная терраса для отдыха
• Идеально для установки мебели на улице
• Место для бассейна или купели рядом
• Компактная, но функциональная планировка внутри""",
            "order": 4
        },
        {
            "calculator_type": "sauna",
            ...
            "answer": """🎯 КАК ВЫБРАТЬ ОПТИМАЛЬНУЮ ПЛАНИРОВКУ?

📋 РЕКОМЕНДАЦИИ ПО ВЫБОРУ:

1️⃣ ВАРИАНТ 1 (СТАНДАРТ) — если:
   • Нужен баланс всех зон
   • Стандартное использование сауны
   • Оптимальное соотношение цена/функциональность

2️⃣ ВАРИАНТ 2 (УВЕЛИЧЕННАЯ ПАРНАЯ) — если:
   • Приоритет — большая парная
   • Семья 4+ человек
   • Любите париться компанией
   • Нужно больше места для полок

3️⃣ ВАРИАНТ 3 (ЭКСТРА ТЕРРАСА) — если:
   • Важна большая открытая зона
   • Планируете ставить мебель на террасе
   • Рядом будет купель/бассейн
   • Любите отдыхать на свежем воздухе

💡 СОВЕТ: Размер 4 метра — самый популярный выбор!
   Оптимальный баланс комфорта и стоимости.""",
            "order": 5
        },
    ]
